...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGC_UE4CPPGameModeBase_Statics::NewProp_FoodToSpawn_MetaData[] = {
		{ "Category", "GC_UE4CPPGameModeBase" },
		{ "ModuleRelativePath", "GC_UE4CPPGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_AGC_UE4CPPGameModeBase_Statics::NewProp_FoodToSpawn = { "FoodToSpawn", nullptr, (EPropertyFlags)0x0014000000000001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGC_UE4CPPGameModeBase, FoodToSpawn), Z_Construct_UClass_AActor_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_AGC_UE4CPPGameModeBase_Statics::NewProp_FoodToSpawn_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGC_UE4CPPGameModeBase_Statics::NewProp_FoodToSpawn_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AGC_UE4CPPGameModeBase_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGC_UE4CPPGameModeBase_Statics::NewProp_FoodToSpawn,
	};
	...
	IMPLEMENT_CLASS(AGC_UE4CPPGameModeBase, 2782184600);
